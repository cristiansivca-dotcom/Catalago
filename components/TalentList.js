    ...
    <div className="max-w-7xl mx-auto px-6 py-12">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
        <div className="max-w-2xl">
          ...
          <p className="text-lg text-slate-500 leading-relaxed">
            Explora nuestra exclusiva selección de profesionales para elevar la presencia de tu
      ...
      <div className="space-y-20">
        {talentosDamas.length > 0 && (
          <section>
            <div className="flex items-center gap-4 mb-8">
              <h3 className="text-2xl font-black text-slate-900 tracking-tight">Damas</h3>
        ...
        {talentosCaballeros.length > 0 && (
          <section>
            <div className="flex items-center gap-4 mb-8">
              <h3 className="text-2xl font-black text-slate-900 tracking-tight">Caballeros</h3>
              <div className="h-px flex-1 bg-slate-100"></div>
              <span className="bg-slate-50 text-slate-400 px-3 py-1 rounded-full text-xs font-bold border border-slate-100">
